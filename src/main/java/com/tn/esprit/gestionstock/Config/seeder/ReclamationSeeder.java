...
public class ReclamationSeeder {
    ...
    public void seed(){
        ...
        Reclamation reclamation6 = new Reclamation("avis defavorable 6 ","Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aliquam amet assumenda blanditiis dolore eaque eos esse et fugit, incidunt nihil, odit quam quibusdam saepe unde, veritatis vero vitae. Dicta. ", produitSeeder.produit1, userSeeder.user1
        );
